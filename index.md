...
This user guide is intended to be used by project contributors (scholars, research assistants, students) and normal users alike. It is accessible at all times from the application — in the header, there is a book sign next to the menu button on the right-hand side:

<p class="text-center">
<img width="200px" src="{{ '/assets/img/user-guide-btn.png' | relative_url }}">
</p>

本ページは、[日本のデジタル文学地図](https://literarymaps.nijl.ac.jp)（通称DLM）プロジェクトの、オープンな<sup id="a2">[1](#f1)</sup>ユーザーガイドです。このプロジェクトは日本文学における歌枕・名所を地図上に表示し、その背景にある歴史的、文化的、ポエティックな意味を提供しています。バックエンドはMongoDBのデータベースで構築され、フロントエンドはJavaScriptのウェブアプリケーションで実現され、データベースコンテンツを閲覧、編集、可視化することができます。
...
![Front-en]({{ '/assets/img/front_en.png' | relative_url }})
...
![Explanatory-notes-en]({{ '/assets/img/explanatory_notes_en.png' | relative_url }})
...
![All-spots-en]({{ '/assets/img/all_spots_en.png' | relative_url }})

You can click on any one spot to reveal some additional information in an overlay:

![Overlay-en]({{ '/assets/img/spot_overlay_en.png' | relative_url }})
...
![Buttons]({{ '/assets/img/all_spots_buttons.png' | relative_url }})
...
![All-spots-table-en]({{ '/assets/img/all_spots_table_en.png' | relative_url }})
...
![Map-switch-en]({{ '/assets/img/map_switch_en.png' | relative_url }})
...
![Spot-detail-en]({{ '/assets/img/spot_detail/spot_detail_en.png' | relative_url }})
...
![Spot-detail-keywords-en]({{ '/assets/img/spot_detail/spot_detail_keywords_en.png' | relative_url }})
...
![Spot-detail-history-en]({{ '/assets/img/spot_detail/spot_detail_history_en.png' | relative_url }})

The third tab, "Poetry", shows all poems from a selection of poetry collections that make reference to the particular spot:

![Spot-detail-poems-en]({{ '/assets/img/spot_detail/spot_detail_poems_en.png' | relative_url }})

All associated poems are shown in a table, and clicking on one reveals more detailed information on it:

![Spot-detail-one-poem-en]({{ '/assets/img/spot_detail/spot_detail_one_poem_en.png' | relative_url }})
...
![Spot-detail-one-poem-romaji-en]({{ '/assets/img/spot_detail/spot_detail_one_poem_romaji_en.png' | relative_url }})
...
![Add-spot-map]({{ '/assets/img/add_spot/add_spot_map.png' | relative_url }})

The other is to click the "Add spot" button on the top right of the table view:

![Add-spot-table-en]({{ '/assets/img/add_spot/add_spot_table_en.png' | relative_url }})

Clicking on either one of the buttons gives you the view to add a new spot:

![Add-spot-en]({{ '/assets/img/add_spot/add_spot_en.png' | relative_url }})
...
![Add-spot-double-click-en]({{ '/assets/img/add_spot/add_spot_double_click_en.png' | relative_url }})
...
![Add-spot-search-en]({{ '/assets/img/add_spot/add_spot_search_en.png' | relative_url }})
...
![Add-spot-select-en]({{ '/assets/img/add_spot/add_spot_select_en.png' | relative_url }})
...
![Front-ja]({{ '/assets/img/front_ja.png' | relative_url }})

このページでは、UIの言語を切替えることができます（選択肢は日本語と英語です）。プロジェクトに関する情報などもフロントページにあります。何よりも先ず、プロジェクトの作業凡例がフロントページに記載されてます：

![Explanatory-notes-ja]({{ '/assets/img/explanatory_notes_ja.png' | relative_url }})
...
![All-spots-ja]({{ '/assets/img/all_spots_ja.png' | relative_url }})

各場所をクリックできますが、一つの場所を選びますと、追加情報が以下の通りに、オーバーレイで表示されます：

![Overlay-ja]({{ '/assets/img/spot_overlay_ja.png' | relative_url }})
...
![All-spots-table-ja]({{ '/assets/img/all_spots_table_ja.png' | relative_url }})

テーブル表示からも、場所の詳細ページを開くことができますし、地名で場所を検索することもできます。地図表示に戻るには、左上の「地図表示」ボタンをクリックするので充分です：

![Map-switch-ja]({{ '/assets/img/map_switch_ja.png' | relative_url }})

## 場所を表示する<a name="displaying-spots-ja"></a>

場所の詳細ページを開きますと、４つのタブの内の、次の「基本情報」というタブが表示されます：

![Spot-detail-ja]({{ '/assets/img/spot_detail/spot_detail_ja.png' | relative_url }})
...
![Spot-detail-keywords-ja]({{ '/assets/img/spot_detail/spot_detail_keywords_ja.png' | relative_url }})
...
![Spot-detail-history-ja]({{ '/assets/img/spot_detail/spot_detail_history_ja.png' | relative_url }})

三つ目の「和歌・漢詩・俳諧」タブは、資料で現れる、選択した場所を表現する和歌等をテーブルで表示します：

![Spot-detail-poems-ja]({{ '/assets/img/spot_detail/spot_detail_poems_ja.png' | relative_url }})

各エントリーをクリックしますと、そのエントリーの詳細情報が現れます：

![Spot-detail-one-poem-ja]({{ '/assets/img/spot_detail/spot_detail_one_poem_ja.png' | relative_url }})
...
![Spot-detail-one-poem-romaji-ja]({{ '/assets/img/spot_detail/spot_detail_one_poem_romaji_ja.png' | relative_url }})
...
![Add-spot-table-ja]({{ '/assets/img/add_spot/add_spot_table_ja.png' | relative_url }})

クリック後、場所の追加画面が表示されます:

![Add-spot-ja]({{ '/assets/img/add_spot/add_spot_ja.png' | relative_url }})
...
![Add-spot-double-click-ja]({{ '/assets/img/add_spot/add_spot_double_click_ja.png' | relative_url }})
...
![Add-spot-search-ja]({{ '/assets/img/add_spot/add_spot_search_ja.png' | relative_url }})

アプリケーションの提案のどれかを選びますと、自動的にマーカーと地名と経緯度が追加されます：

![Add-spot-select-ja]({{ '/assets/img/add_spot/add_spot_select_ja.png' | relative_url }})
...
Heidelberg, Germany, November 2020 — ハイデルベルク、ドイツ、令和二年十一月<br>
Leo Born / ボルン礼於
